...
public final class UploadManager {
	...
	private static void checkArgs(final String key, byte[] data, File f,
			String token) {
		String message = null;
		if (f == null && data == null) {
	 ...
	 * @throws QiniuException
	 */
	public Response put(final byte[] data, final String key,
			final String token, StringMap params, String mime, boolean checkCrc)
			throws QiniuException {
		...
		return new FormUploader(client, token, key, data, params, mime,
				checkCrc).upload();
	}
	 ...
	 *            上传凭证
	 */
	public Response put(String filePath, String key, String token)
			throws QiniuException {
	 ...
	 *            上传凭证
	 */
	public Response put(File file, String key, String token)
			throws QiniuException {
	...
	public Response put(File file, String key, String token, StringMap params,
		...
		if (size <= Config.PUT_THRESHOLD) {
			return new FormUploader(client, token, key, file, params, mime,
					checkCrc).upload();
		}
	...
	public void asyncPut(final byte[] data, final String key,
			final String token, StringMap params, String mime,
		...
		params = filterParam(params);
		new FormUploader(client, token, key, data, params, mime, checkCrc)
				.asyncUpload(handler);
	}
}
